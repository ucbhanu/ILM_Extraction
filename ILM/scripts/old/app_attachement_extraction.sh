...
#AWS Lambda Function
#QA
LAMBDA_FUNC="qa-informatica-bulk-app-file-download"

#PROD
#LAMBDA_FUNC="prod-informatica-bulk-app-file-download"

#Export location
#QA
EXPORT_LOC="bulk-download.qa.int.bayer.com"

#PROD
#EXPORT_LOC="bulk-download.prod.int.bayer.com"
...
log "INFO" "Export location: $EXPORT_LOC/$APP_NAME/$STARTDATE"
